...
print('\n\nRead Excel File')
df_xlsx = pd.read_excel(r'C:\Users\Administrator\Desktop\Cloud Data Engineering\1. Complete Python\11. Complete Pandas\1. Read & Load File\demo_education_data.xlsx') # ✅
